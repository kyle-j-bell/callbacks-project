...
*******************************************************************************/
/*Accepts an array and a callback as arguments.  Uses a 'for' loop to pass elements from the array into the callback, then pushes them to a new array if they return true.*/
...
/*In this example, the callback returns true if a number is greater than 2.*/
let cb = function(num) {
    return num > 2;
}
