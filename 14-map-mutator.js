...
*******************************************************************************/
/*Accepts an array and a callback as arguments.  Uses a 'for' loop to mutate the array by passing each element and its index into a callback.*/
let mapMutator = function(array, cb) {
    for (let i = 0; i < array.length; i++) {
        /*Overwrites each element with the result of the element and its index passed through the callback.*/
