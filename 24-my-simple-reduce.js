...
let mySimpleReduce = function(array, cb) {
    /*Assigns the first element of the array to a variable.*/
    let accumulator = array[0];
    /*Declares but does not initialize a 'result' variable.*/
    let result;
    /*Iterates through the array starting at its second element.*/
    for (let i = 1; i < array.length; i++) {
        /*Assigns the current element of the array to a variable.*/
        let initialValue = array[i];
        /*Assigns the result of accumulator and initialValue pushed to the callback.*/
        result = cb(accumulator, initialValue);
        /*Assigns accumulator the value of result.*/
        accumulator = result;
    }
...
/*In this example, a simple sum callback is used to mimic a common way to explain how Array.reduce() works.*/
