...
let myForEach = function(array, cb) {
    /*Uses a 'for' loop to pass array elements and their indices into the callback.*/
    for (let i = 0; i < array.length; i++) {
        cb(array[i], i);
    }
}
/*In this example, the callback prints a simple message telling the user the current array element and its index.*/
let cb = function (item, index) {
    console.log("In this array, " + item + " is at index " + index + ".");
}
